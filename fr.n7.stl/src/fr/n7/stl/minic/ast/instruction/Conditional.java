...
public class Conditional implements Instruction {
	...
	public Fragment getCode(TAMFactory _factory) {
        ...
        // _result.add(_factory.createPop(0,0)); // permet d'éviter des pb de partage de reference
        // Si le bloc fini par un "print xx;" alors le suffixe est ajouté sur tous les print
        // du code. Ceci n'est plus nécéssaire le jour ou le printer utilise la factory pour
