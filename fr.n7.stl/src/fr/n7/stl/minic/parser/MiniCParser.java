...
public class MiniCParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class InstructionSiSeulContext extends InstructionContext {
		...
		public InstructionSiSeulContext(InstructionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MiniCParserListener ) ((MiniCParserListener)listener).enterInstructionSiSeul(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MiniCParserListener ) ((MiniCParserListener)listener).exitInstructionSiSeul(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				break;
			case 5:
				_localctx = new InstructionSiSeulContext(_localctx);
				...
				match(ParentheseFermante);
				setState(123);
				((InstructionSiSeulContext)_localctx).alors = bloc();
				}
				break;
			case 6:
