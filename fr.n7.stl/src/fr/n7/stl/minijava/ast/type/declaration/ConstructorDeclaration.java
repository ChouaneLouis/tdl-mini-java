...
public class ConstructorDeclaration extends ClassElement implements Instruction {
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		Fragment consCode = this.body.getCode(_factory);

		consCode.addPrefix("Constructor_" + this.name);
		...
		consCode.add(_factory.createReturn(0, parametersSize + 1)); // +1 car this !

		fragment.append(consCode);
	...
	public Type getType() {
		...
		throw new SemanticsUndefinedException("gettype in constructordeclaration");
		// eturn null;
	}
